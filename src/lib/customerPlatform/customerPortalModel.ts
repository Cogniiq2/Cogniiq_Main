...
// The rail's per-project children (`buildRailProjectChildren` in PR #20) are deliberately
// NOT part of this module. The customer sidebar is now generated exclusively from effective
// capabilities by `src/lib/portalAccess/navigation.ts`; a second, data-derived source of
// navigation entries would be exactly the duplicate navigation model that architecture
// exists to prevent. Projects are reached from the overview and from the project routes.
