...
export const CITY_SERVICE_CONFIGS: Record<string, CityServiceConfig> = {
  ...
  "bayreuth/ki-telefonassistent": {
    ...
    faq: [
      ...
      { question: "Wie schnell ist der Assistent live?", answer: `${FAKTEN.goLive} Enthalten sind Erstgespräch, Ihre Vorgaben, der Aufbau und zwei Tage Testphase. Live geht der Assistent erst, wenn Sie ihn gehört und freigegeben haben.` },
  ...
  "muenchen/ki-telefonassistent": {
    ...
    faq: [
      ...
      { question: "Wie schnell ist die Einrichtung?", answer: `${FAKTEN.goLive} Enthalten sind Erstgespräch, Ihre Vorgaben, der Aufbau und zwei Tage Testphase. Live geht der Assistent erst nach Ihrer Freigabe.` },
