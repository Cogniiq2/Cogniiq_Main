...
export const CITY_SERVICE_CONFIGS: Record<string, CityServiceConfig> = {
  ...
  "bayreuth/ki-telefonassistent": {
    ...
    faq: [
      ...
      { question: "Können mehrere Anrufe gleichzeitig ankommen?", answer: "Ja. Der Assistent nimmt mehrere Anrufe zur selben Zeit an, statt sie in eine Warteschleife zu stellen; die Kapazität wird auf Ihr Aufkommen ausgelegt und im Angebot ausgewiesen. Das ist gerade zu Stoßzeiten der eigentliche Unterschied zum klassischen Empfang mit einer Leitung." },
  ...
  "bayreuth/automatisierung": {
    ...
    faq: [
      ...
      { question: "Können bestehende Systeme in Automatisierungen integriert werden?", answer: "Ja, sofern die Software eine geeignete Schnittstelle hat. Das gilt für CRM, Buchungssystem, Buchhaltungssoftware und branchenspezifische Anwendungen für Bayreuth-Unternehmen gleichermaßen — ob und in welchem Umfang es für Ihr System zutrifft, prüfen wir vor dem Angebot." },
  ...
  "bayreuth/webdesign": {
    ...
    legacyWebdesignLink: "/webdesign-agentur-deutschland",
    seo: {
  ...
  "regensburg/ki-telefonassistent": {
    ...
    faq: [
      ...
      { question: "Funktioniert der Assistent auch bei hohem Anrufaufkommen in der Tourismussaison?", answer: "Ja. Der Assistent nimmt mehrere Anrufe zur selben Zeit an, statt sie in eine Warteschleife zu stellen; die Kapazität wird auf Ihr Aufkommen ausgelegt und im Angebot ausgewiesen. Das ist gerade in der Hauptsaison der Unterschied zu einer einzelnen besetzten Leitung." },
  ...
  "regensburg/webdesign": {
    ...
    faq: [
      ...
      { question: "Wie lange dauert ein Webdesign-Projekt in Regensburg?", answer: "Das hängt an Umfang, Inhaltsversorgung und Freigabezeiten. Nach dem Erstgespräch erhalten Sie einen Zeitplan mit Meilensteinen; pauschale Fristen nennen wir vorher nicht." },
      { question: "Was kostet eine Website für ein Regensburger Unternehmen?", answer: "Der Preis richtet sich nach Seitenumfang, Inhalten, Designaufwand, Schnittstellen und Betreuung. Was den Preis bestimmt, erklärt unsere Seite zu den Webdesign-Kosten; ein konkretes Angebot folgt auf das kostenlose Erstgespräch." },
      { question: "Baut ihr auf WordPress oder individuellem Code?", answer: "Das entscheidet die Anforderung: Wer Inhalte selbst pflegen will, braucht ein Redaktionssystem; wer vor allem Geschwindigkeit und wenig Wartung braucht, eine statisch ausgelieferte Website. Welche Grundlage wir vorschlagen, steht mit Begründung im Angebot." },
  ...
  "muenchen/ki-telefonassistent": {
    ...
    faq: [
      ...
      { question: "Was passiert bei mehreren Anrufen gleichzeitig?", answer: "Mehrere Anrufe werden zur selben Zeit angenommen, statt in eine Warteschleife zu laufen; die Kapazität wird auf Ihr Aufkommen ausgelegt und im Angebot ausgewiesen. Gerade zu Stoßzeiten wie Messen oder Ferienbeginn ist das der Unterschied zu einer einzelnen Leitung." },
  ...
  "muenchen/webdesign": {
    ...
    faq: [
      ...
      { question: "Was kostet eine Website für ein Münchner Unternehmen?", answer: "Der Preis richtet sich nach Seitenumfang, Inhalten, Designaufwand, Schnittstellen und Betreuung. Welche Faktoren den Preis für den Münchner Markt bestimmen, erklärt unsere Seite „Webdesign Kosten München“; ein konkretes Angebot folgt auf das Erstgespräch." },
      ...
      { question: "Wie schnell kann eine Website live gehen?", answer: "Das hängt an Umfang, Inhaltsversorgung und Freigabezeiten. Nach dem Erstgespräch erhalten Sie einen Zeitplan mit Meilensteinen; pauschale Fristen nennen wir vorher nicht." },
