...
export const CITY_SERVICE_CONFIGS: Record<string, CityServiceConfig> = {
  ...
  "regensburg/ki-telefonassistent": {
    ...
    localIntro: {
      paragraphs: [
        ...
        "Die Einrichtung dauert in der Regel 7–14 Tage und läuft im Hintergrund: Ihre Anrufe werden auf den Assistenten umgeleitet, Ihr Team muss nichts Neues lernen. Ein Auftragsverarbeitungsvertrag nach Art. 28 DSGVO gehört zur Einrichtung, Gespräche werden nicht aufgezeichnet.",
  ...
  "muenchen/ki-telefonassistent": {
    ...
    faq: [
      ...
      { question: "Was passiert mit sensiblen Patientendaten oder Geschäftsinformationen?", answer: "Ein Auftragsverarbeitungsvertrag nach Art. 28 DSGVO gehört zur Einrichtung. Gespräche werden nicht aufgezeichnet – gespeichert wird ausschließlich das strukturierte Ergebnis. Ihre Daten werden nicht zum Training von Modellen verwendet." },
