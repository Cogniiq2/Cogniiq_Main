...
export const CITY_SERVICE_CONFIGS: Record<string, CityServiceConfig> = {
  ...
  "regensburg/ki-telefonassistent": {
    ...
    localIntro: {
      paragraphs: [
        "Regensburg gehört zu den wachstumsstärksten Städten Bayerns – mit Universität und Uniklinikum, starkem Mittelstand, dichter Altstadtgastronomie und ganzjährigem Tourismus in der UNESCO-Welterbe-Altstadt. Diese Mischung prägt auch das Telefon: Anfragen kommen zu jeder Tages- und Abendzeit, in der Tourismussaison und zu Semesterbeginn deutlich mehr – das Personal in Praxen, Küchen und Werkstätten wächst aber nicht mit.",
        ...
        "Die Einrichtung dauert in der Regel 7–14 Tage und läuft im Hintergrund: Ihre Rufnummer bleibt, Ihre Telefonanlage bleibt, Ihr Team muss nichts Neues lernen. Die Verarbeitung läuft auf europäischen Servern, ein Auftragsverarbeitungsvertrag nach Art. 28 DSGVO gehört zur Einrichtung.",
    ...
    useCases: [
      {
        ...
        title: "Entlastung für die Anmeldung zu Stoßzeiten",
        description: "Rund um das Uniklinikum ist die Dichte an Praxen hoch – und montags, nach Feiertagen und in Infektwellen steht das Telefon kaum still. Der Assistent nimmt Terminwünsche und Stornierungen strukturiert auf; medizinische Auskünfte gibt er nicht, Notfall-Hinweise gehen sofort an einen Menschen.",
      },
      {
    ...
    faq: [
      ...
      { question: "Was kostet der KI Telefonassistent?", answer: "Sie zahlen einen festen Monatsbetrag für einen definierten Leistungsumfang – keine Abrechnung pro Anruf. Nach dem Erstgespräch erhalten Sie ein schriftliches Festpreisangebot, in dem auch Einmalposten offen ausgewiesen sind." },
  ...
  "muenchen/ki-telefonassistent": {
    ...
    localIntro: {
      paragraphs: [
        ...
        "Cogniiq betreut Münchner Projekte vollständig remote; persönliche Termine im Raum München sind auf Anfrage möglich. Die Einrichtung dauert in der Regel 7–14 Tage, die Verarbeitung läuft auf europäischen Servern, ein Auftragsverarbeitungsvertrag nach Art. 28 DSGVO gehört dazu. Die Kosten sind fest vereinbart – ein Monatsbetrag für einen definierten Umfang, keine Abrechnung pro Anruf.",
    ...
    faq: [
      ...
      { question: "Was kostet der KI Telefonassistent für ein Münchner Unternehmen?", answer: "Dieselben Konditionen wie überall: ein fester Monatsbetrag für einen definierten Leistungsumfang, keine Abrechnung pro Anruf. Nach dem Erstgespräch erhalten Sie ein schriftliches Festpreisangebot mit allen Posten." },
      ...
      { question: "Was passiert mit sensiblen Patientendaten oder Geschäftsinformationen?", answer: "Die Verarbeitung läuft auf europäischen Servern, ein Auftragsverarbeitungsvertrag nach Art. 28 DSGVO gehört zur Einrichtung. Gespräche werden als strukturierte Zusammenfassung übergeben, nicht als Rohaudio gespeichert, sofern Sie das nicht wünschen." },
    ...
    localChallenges: [
      "München hat einen der dichtesten Dienstleistungsmärkte Deutschlands – wer telefonisch schwer erreichbar ist, macht es Anrufern leicht, beim nächsten Anbieter anzurufen",
