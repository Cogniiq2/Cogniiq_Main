...
export const CITY_SERVICE_CONFIGS: Record<string, CityServiceConfig> = {
  ...
  "bayreuth/ki-telefonassistent": {
    ...
    faq: [
      ...
      { question: "Können mehrere Anrufe gleichzeitig ankommen?", answer: "Ja. Der Assistent nimmt bis zu 10 Anrufe gleichzeitig an – ohne Warteschleife. Das ist gerade zu Stoßzeiten der eigentliche Unterschied zum klassischen Empfang mit einer Leitung." },
  ...
  "bayreuth/automatisierung": {
    ...
    faq: [
      ...
      { question: "Können bestehende Systeme in Automatisierungen integriert werden?", answer: "Ja, sofern die Software eine geeignete Schnittstelle hat – CRM, Buchungssystem, Buchhaltungssoftware oder branchenspezifische Anwendungen für Bayreuth-Unternehmen. Ob und in welchem Umfang das für Ihr System gilt, prüfen wir vor dem Angebot." },
  ...
  "regensburg/ki-telefonassistent": {
    ...
    faq: [
      ...
      { question: "Funktioniert der Assistent auch bei hohem Anrufaufkommen in der Tourismussaison?", answer: "Ja. Der Assistent nimmt bis zu 10 Anrufe gleichzeitig an – ohne Warteschleife. Das ist gerade in der Hauptsaison der Unterschied zu einer einzelnen besetzten Leitung." },
