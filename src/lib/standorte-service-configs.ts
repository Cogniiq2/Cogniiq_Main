...
export const CITY_SERVICE_CONFIGS: Record<string, CityServiceConfig> = {
  ...
  "bayreuth/ki-telefonassistent": {
    ...
    localIntro: {
      paragraphs: [
        ...
        `Die Einrichtung übernimmt Cogniiq vollständig; Ihre Anrufe werden auf den Assistenten umgeleitet. ${FAKTEN.goLive} Als Anbieter mit Hauptsitz in Bayreuth sind wir direkt erreichbar – mit festem Ansprechpartner statt Ticketsystem, auf Wunsch auch mit Terminen vor Ort.`,
    ...
    faq: [
      ...
      { question: "Was kostet der KI Telefonassistent?", answer: `Sie zahlen einen festen Monatsbetrag für ein Minutenkontingent. ${FAKTEN.deckelung} ${FAKTEN.tarifzuordnung} Nach dem Analysegespräch erhalten Sie ein schriftliches Angebot, in dem auch Einmalposten wie die Einrichtung offen ausgewiesen sind.` },
      { question: "Wie schnell ist der Assistent live?", answer: `${FAKTEN.goLive} Enthalten sind Analysegespräch, Ihre Vorgaben, der Aufbau und zwei Tage Testphase. Live geht der Assistent erst, wenn Sie ihn gehört und freigegeben haben.` },
  ...
  "bayreuth/automatisierung": {
    ...
    faq: [
      ...
      { question: "Was kostet Prozessautomatisierung in Bayreuth?", answer: "Das hängt von der Komplexität ab. Einfache Workflows starten ab ca. 500–1.500 €, komplexere Projekte nach Aufwand. Das Analysegespräch und eine erste Einschätzung sind kostenlos und unverbindlich." },
  ...
  "bayreuth/webdesign": {
    ...
    faq: [
      ...
      { question: "Was kostet eine Website für ein Unternehmen in Bayreuth?", answer: "Websites starten ab ca. 1.500 €. Individuell entwickelte Unternehmenswebsites liegen je nach Umfang typischerweise bei ca. 2.500–5.000 €, komplexere Projekte nach Aufwand. Analysegespräch und grobe Einschätzung sind kostenlos." },
  ...
  "regensburg/ki-telefonassistent": {
    ...
    localIntro: {
      paragraphs: [
        ...
        `Die Einrichtung läuft im Hintergrund: Ihre Anrufe werden auf den Assistenten umgeleitet, Ihr Team muss nichts Neues lernen. ${FAKTEN.goLive} Ein Auftragsverarbeitungsvertrag nach Art. 28 DSGVO gehört dazu, ${FAKTEN.keineAufzeichnung}`,
    ...
    faq: [
      ...
      { question: "Was passiert bei einem technischen Ausfall?", answer: "Für den Störungsfall wird ein Fallback eingerichtet: Anrufe laufen dann auf eine von Ihnen benannte Nummer oder auf eine klare Ansage mit dem nächsten Schritt. Diesen Weg legen wir gemeinsam bei der Einrichtung fest." },
      { question: "Worauf müssen Sie bei DSGVO und KI Telefonassistent achten?", answer: "Vier Punkte entscheiden, und Sie sollten sie bei jedem Anbieter abfragen: Wird das Gespräch aufgezeichnet und wie lange gespeichert. Werden Ihre Daten zum Training von Modellen verwendet. Gibt es einen Auftragsverarbeitungsvertrag nach Art. 28 DSGVO. Und wie wird die Schweigepflicht nach § 203 StGB vertraglich abgebildet. Bei uns: Gespräche werden nicht aufgezeichnet – gespeichert wird ausschließlich das strukturierte Ergebnis. Ihre Daten werden nicht zum Training von Modellen verwendet. Einen AVV nach Art. 28 DSGVO stellen wir jedem Kunden bereit. Cogniiq und alle Mitarbeitenden werden vertraglich auf das Berufsgeheimnis nach § 203 StGB verpflichtet. Der Assistent gibt sich zu Beginn jedes Anrufs als KI-System zu erkennen. Bei der Dokumentation für Ihren Datenschutzbeauftragten unterstützen wir." },
      { question: "Können wir den Assistenten vor der Entscheidung hören?", answer: "Ja. Im unverbindlichen Analysegespräch zeigen wir eine Beispielkonfiguration für Ihren Anwendungsfall. Vor dem Start testen Sie mit echten Szenarien – live geht der Assistent erst nach Ihrer Freigabe." },
      { question: "Was kostet der KI Telefonassistent?", answer: `Sie zahlen einen festen Monatsbetrag für ein Minutenkontingent. ${FAKTEN.deckelung} ${FAKTEN.tarifzuordnung} Nach dem Analysegespräch erhalten Sie ein schriftliches Angebot, in dem auch Einmalposten offen ausgewiesen sind.` },
      ...
      { question: "Kann der Assistent auch auf Englisch sprechen?", answer: "Für Betriebe mit internationalem Publikum – Tourismus, Universität, Technologie – sind mehrsprachige Konfigurationen möglich, üblicherweise Deutsch und Englisch. Den konkreten Umfang klären wir im Analysegespräch." },
  ...
  "regensburg/automatisierung": {
    ...
    faq: [
      { question: "Für welche Unternehmensgrößen lohnt sich Automatisierung in Regensburg?", answer: "Ab etwa 3–5 Mitarbeitern gibt es fast immer Prozesse, die sich lohnen zu automatisieren. Wir schauen uns das im kostenfreien Analysegespräch gemeinsam an." },
      ...
      { question: "Was kostet Prozessautomatisierung in Regensburg?", answer: "Erste Workflows ab ca. 500 €, komplexere Integrationen nach Aufwand. Analysegespräch und Einschätzung sind immer kostenlos." },
  ...
  "regensburg/webdesign": {
    ...
    faq: [
      ...
      { question: "Was kostet eine Website für ein Regensburger Unternehmen?", answer: "Websites starten ab ca. 1.500 €. Individuell entwickelte Unternehmenswebsites liegen je nach Umfang typischerweise bei ca. 2.500–5.000 €, komplexere Projekte nach Aufwand. Analysegespräch kostenlos." },
  ...
  "muenchen/ki-telefonassistent": {
    ...
    processSteps: TELEFONASSISTENT_PROZESS,
    faq: [
      { question: "Kann der Assistent auf Englisch mit internationalen Kunden sprechen?", answer: "Mehrsprachige Konfigurationen sind möglich – üblicherweise Deutsch und Englisch. Wie die Sprachwahl im Gespräch abläuft und welche Sprachen Sie brauchen, klären wir im Analysegespräch und testen es vor dem Start." },
      ...
      { question: "Was kostet der KI Telefonassistent für ein Münchner Unternehmen?", answer: `Dieselben Konditionen wie überall: ein fester Monatsbetrag für ein Minutenkontingent. ${FAKTEN.deckelung} Nach dem Analysegespräch erhalten Sie ein schriftliches Angebot mit allen Posten.` },
      ...
      { question: "Wie schnell ist die Einrichtung?", answer: `${FAKTEN.goLive} Enthalten sind Analysegespräch, Ihre Vorgaben, der Aufbau und zwei Tage Testphase. Live geht der Assistent erst nach Ihrer Freigabe.` },
