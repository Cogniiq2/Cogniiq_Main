    ...
    <AuthPageLayout
      ...
      footer={
        <p className="text-sm text-gray-500">
          Need a fresh link?{' '}
          <Link to="/app/forgot-password" className="font-semibold text-gray-900 hover:text-gray-600">
            Request one
          </Link>
        </p>
      }
      ...
      {noSession ? (
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <label className="block">
            <span className="mb-1.5 block text-xs font-semibold text-gray-700">New password</span>
            <input
              type="password"
              required
