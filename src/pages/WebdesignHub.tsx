                ...
                {BRANCHEN.map(({ icon: Icon, label, href }) => (
                  <li key={href}>
                    ...
                    >
                      ...
                      <ArrowRight size={13} className="ml-auto text-gray-300 dark:text-white/20 group-hover:text-blue-400" />
                    </Link>
                  </li>
                ))}
              </ul>
                  ...
                  <li key={href}>
                    ...
                    >
                      ...
                      <span>
                        ...
                        <span className="block text-xs text-gray-400 dark:text-white/35">{sub}</span>
                      </span>
                      <ArrowRight size={13} className="ml-auto mt-1 text-gray-300 dark:text-white/20 group-hover:text-blue-400" />
                    </Link>
                  </li>
                ))}
              </ul>
              <p className="mt-4 text-xs text-gray-400 dark:text-white/35 leading-relaxed">
