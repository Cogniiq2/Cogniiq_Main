...
function Mehr({ label, href }: { label: string; href: string }) {
  return (
    <Link
      to={href}
      className="group inline-flex items-center gap-2 mt-5 text-[17px] text-pub-accent dark:text-gray-300 underline underline-offset-4 decoration-pub-accent-line dark:decoration-gray-600 hover:decoration-pub-accent dark:hover:decoration-gray-400 transition-colors"
    >
      {label}
