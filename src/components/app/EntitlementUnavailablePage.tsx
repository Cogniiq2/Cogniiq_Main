...
export function EntitlementUnavailablePage({
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-[#f7f7f4] px-6 py-16">
      <div className="w-full max-w-md rounded-2xl border border-gray-200 bg-white p-7 text-center shadow-[0_18px_60px_rgba(15,23,42,0.08)]">
        ...
        <div className="flex flex-col gap-2">
          <Link
            to="/app"
            className="inline-flex items-center justify-center rounded-xl bg-gray-950 px-4 py-2.5 text-sm font-semibold text-white transition-colors hover:bg-gray-800 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-gray-400 focus-visible:ring-offset-2"
          >
            Zur Übersicht
          </Link>
          {supportEmail ? (
            <a
              ...
              className="inline-flex items-center justify-center rounded-xl border border-gray-200 px-4 py-2.5 text-sm font-semibold text-gray-600 transition-colors hover:border-gray-300 hover:text-gray-950 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-gray-400 focus-visible:ring-offset-2"
            >
