...
const problems = [
  ...
  },
  {
    ...
    stat: 'Ohne',
    statLabel: 'klare Conversion-Führung keine Anfragen',
    accent: false,
  ...
  },
  {
    ...
    body: 'Terminverwaltung, Follow-ups, Angebote per Hand – das summiert sich Woche für Woche. Zeit, die für das Kerngeschäft fehlt.',
    stat: 'Wöchentlich',
    statLabel: 'Stunden für wiederkehrende Handarbeit',
    accent: false,
  ...
  },
  {
    ...
    stat: 'Seite 1',
    statLabel: 'entscheidet über Sichtbarkeit',
    accent: false,
    href: '/keine-anfragen-website',
  },
  {
    ...
    stat: 'Isoliert',
    statLabel: 'Tools ohne gemeinsame Datenbasis',
    accent: false,
