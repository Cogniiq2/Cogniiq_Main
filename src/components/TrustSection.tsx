  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        ...
        {/* Cards – 3 on top, 2 perfectly centered below */}
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-10 place-items-center">
          ...
          {points.slice(0, 3).map((item, index) => (
            <motion.div
              ...
              className="p-8 rounded-3xl bg-white border border-gray-200 shadow-sm hover:shadow-lg transition-all w-full max-w-md"
            >
              {item.icon}
          ...
          {/* GHOST to complete grid structure */}
          <div className="hidden lg:block"></div>
        </div>
